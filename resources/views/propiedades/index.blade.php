...
.hp-help-inline{display:inline-flex;align-items:center;gap:8px;margin-bottom:12px}
  ...
  <div class="hp-help-panel" role="dialog" aria-modal="true" aria-label="Guía de uso de propiedades">
    ...
    <div class="hp-help-stage" id="hp-help-stage">
      <img id="hp-help-image" class="hp-help-image"
        src="{{ asset('tutorial_imgs/no-admin/Propiedades.png') }}"
...
<div id="modal-prop-edit" class="modal" aria-hidden="true" style="display:none;align-items:center;justify-content:center;">
  ...
  <div class="modal-panel" role="dialog" aria-modal="true" style="position:relative;z-index:1200;max-width:900px;">
    ...
    <form id="form-prop-edit" method="POST" action="#" class="form">
      ...
      <label class="field"><span class="label-text">Imagen principal (ruta pública)</span>
        <div style="display:flex;gap:8px;align-items:center;">
          <input id="e-ruta_img" name="ruta_img" placeholder="resources\tutorial_imgs\no-admin\Propiedades.png" style="flex:1;padding:8px;border-radius:8px;border:1px solid #e5e7eb;" />
