...
<head>
  ...
  <title>Acceso denegado — HomeRes</title>
  <style>
    *{box-sizing:border-box}
    ...
    .code{font-size:4rem;font-weight:800;color:#fecaca;line-height:1;margin-bottom:4px}
...
<body>
  <div class="box">
    ...
    <p>No tienes permisos para realizar esta acción. Si crees que esto es un error, contacta al administrador.</p>
